...
class Student:
    ...
    def getDetails(self):
            ...
            for i in range(self.no_of_courses):
                ...
                while True:
                   try:
                      score = float(input(f"Enter {self.name.title()} score: "))
                      break
                   except ValueError:
                    print("ERROR!!\nACCEPTS ONLY NUMBERS")
                while True:
                    try:
                      unit = int(input(f"How many unit is {course.title()}: "))
                      break
                    except ValueError:
                        print("ERROR!!\nACCEPTS ONLY INTEGERS")
    ...
    def UpdateStudentScore(self):
        ...
        if self.filefound:
              ...
              for s in self.temporary_db:
                ...
                if name.strip().lower() == s['name'].strip().lower():
                   ...
                   for course in courses:
                       if course_name.strip().lower() == course['course'].strip().lower():
                           course_found = True
              ...
              if student_found:
                 ...
                 self.temporary_db = [s for s in self.temporary_db if name.strip().lower() != s['name'].strip().lower()]
                 self.Calculategpa()
