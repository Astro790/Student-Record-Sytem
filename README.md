# Student-Record-Sytem
An interactive python CRUD command line application that allows users to manage student data and calculate student grade and save in a JSON file.
Features:-
 - Create student data
